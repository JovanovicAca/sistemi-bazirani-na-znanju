...
public class TrainStation implements Serializable {
    ...
    public TrainStation id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public TrainStation name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public TrainStation destination(Destination destination) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((TrainStation) o).id);
    }
